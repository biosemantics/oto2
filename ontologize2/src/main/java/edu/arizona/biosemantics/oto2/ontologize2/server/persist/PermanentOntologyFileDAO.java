...
//		try {
//			for(Ontology ontology : new edu.arizona.biosemantics.oto2.ontologize2.server.persist.db.OntologyDAO().getBioportalOntologies()) {
...
//		}
	...
	public PermanentOntologyFileDAO() throws OWLOntologyCreationException {
		...
		owlOntologyRetriever = new OWLOntologyRetriever(owlOntologyManager);
