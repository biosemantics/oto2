...
/**
 * 
 * This class is used for persisting the Ontology Classes
 * 
 * @author maojin
 *
 */
public class OntologyClassSubmission implements HasSynonym, HasLabelAndIri, Serializable, 
	...
	public OntologyClassSubmission(Term term, String submissionTerm, Ontology ontology, String classIRI,
			List<Superclass> superclasses, List<Synonym> synonyms, 
			List<PartOf> partOfs) { 
		this.term = term;
