...
public class SubmitLocalClassView implements IsWidget {
	...
	private TextButton obsoleteSubmit = new TextButton("Remove and Save as New");
	...
	public SubmitLocalClassView(EventBus eventBus) {
	...
	private void bindEvents() {
		...
		eventBus.addHandler(TermSelectEvent.TYPE, new TermSelectEvent.Handler() {
			...
			public void onSelect(TermSelectEvent event) {
				if(!event.getSource().equals(SubmitLocalClassView.this)) {
					clearFields(false);
					setSelectedSubmission(null);
