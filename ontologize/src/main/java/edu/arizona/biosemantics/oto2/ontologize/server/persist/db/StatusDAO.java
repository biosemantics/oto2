...
public class StatusDAO {
	...
	public Status get(int id) throws QueryException  {
		Status status = null;
		try(Query query = new Query("SELECT * FROM ontologize_status WHERE id = ?")) {
	...
	public Status get(String name) throws QueryException {
		Status status = null;
		try(Query query = new Query("SELECT * FROM ontologize_status WHERE name = ?")) {
	...
	public void update(Status status) throws QueryException  {		
		try(Query query = new Query("UPDATE ontologize_status SET name = ? WHERE id = ?")) {
	...
	public void remove(Status status) throws QueryException  {
		try(Query query = new Query("DELETE FROM ontologize_status WHERE id = ?")) {
