...
public class CreateSubmissionView3 implements IsWidget {
	...
	public CreateSubmissionView3(EventBus eventBus) {
	...
	private void bindEvents() {
		...
		eventBus.addHandler(LoadCollectionEvent.TYPE, new LoadCollectionEvent.Handler() {
			...
			public void onLoad(LoadCollectionEvent event) {
				CreateSubmissionView3.this.collection = event.getCollection();
				...
				toOntologyService.getLocalOntologies(collection, new AsyncCallback<List<Ontology>>() {
					...
					public void onSuccess(List<Ontology> result) {
						CreateSubmissionView3.this.ontology = result.get(0);
					}
				});
			}
		});
