...
import edu.arizona.biosemantics.oto2.theme.client.sliced.panel.SlicedFramedPanelAppearance;
...
public class SlicedWindowAppearance extends SlicedFramedPanelAppearance implements WindowAppearance {
  ...
  public interface SlicedWindowDivFrameResources extends SlicedFramedPanelDivFrameResources {
    @Source({"edu/arizona/biosemantics/oto2/theme/client/sliced/panel/SlicedFramedPanelDivFrame.css"})
    @Override
