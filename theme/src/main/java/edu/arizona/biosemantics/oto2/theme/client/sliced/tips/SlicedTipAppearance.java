 ...
 */
package edu.arizona.biosemantics.oto2.theme.client.sliced.tips;
...
public class SlicedTipAppearance extends TipDefaultAppearance {
  ...
  public interface SlicedTipResources extends TipResources {
    ...
    @Override
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tips/anchorBottom.png")
    ImageResource anchorBottom();

    @Override
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tips/anchorLeft.png")
    ImageResource anchorLeft();

    @Override
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tips/anchorRight.png")
    ImageResource anchorRight();

    @Override
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tips/anchorTop.png")
