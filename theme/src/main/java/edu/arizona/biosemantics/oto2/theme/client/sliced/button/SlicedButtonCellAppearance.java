 ...
 */
package edu.arizona.biosemantics.oto2.theme.client.sliced.button;
...
import edu.arizona.biosemantics.oto2.theme.client.ThemeDetails;
...
public class SlicedButtonCellAppearance<C> extends ButtonCellDefaultAppearance<C> {
  ...
  public interface SlicedButtonCellResources extends ButtonCellResources {
    ...
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/arrow.png")
    ImageResource arrow();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/arrowBottom.png")
    ImageResource arrowBottom();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/split.png")
    ImageResource split();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/splitBottom.png")
    ImageResource splitBottom();


    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/toolBarArrow.png")
    ImageResource toolBarArrow();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/toolBarArrowBottom.png")
    ImageResource toolBarArrowBottom();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/toolBarButtonSplit.png")
    ImageResource toolBarSplit();

    @ImageOptions(repeatStyle = RepeatStyle.None)
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/button/toolBarButtonSplitBottom.png")
