 ...
 */
package edu.arizona.biosemantics.oto2.theme.client.sliced.tabs;
...
public class SlicedTabPanelAppearance implements TabPanelAppearance {
  ...
  public interface SlicedTabPanelResources extends ClientBundle {
    ...
    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tabs/scrollerLeft.png")
    ImageResource scrollerLeftArrow();

    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tabs/scrollerRight.png")
    ImageResource scrollerRightArrow();

    @Source("edu/arizona/biosemantics/oto2/theme/client/base/tabs/tabClose.png")
